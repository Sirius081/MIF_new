          ...
          <ul id="menu-top" class="nav navbar-nav navbar-right">
            ...
            <li>
              ...
              <ul class="dropdown-menu" role="menu" aria-labelledby="ddlmenuItem">
                ...
                <li role="presentation"><a role="menuitem" tabindex="-1" href="mif.jsp">基金缴费模型</a></li>
            ...
            <li>
              ...
              <ul class="dropdown-menu" role="menu" aria-labelledby="ddlmenuItem">
                ...
                <li role="presentation"><a role="menuitem" tabindex="-1" href="hospital1.jsp">医院</a></li>
            ...
            <div class="panel panel-info">
              ...
              <div class="panel-body">
                <form id="queryPredict">
                  ...
                  <input id="query1" class="btn btn-primary" type="button" onclick="selectresult()" value="查询"/>
