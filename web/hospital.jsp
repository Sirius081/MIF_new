        ...
        <form id="queryPredict">
            ...
            <div class="col-md-12">
              ...
              <div class="col-md-7" style="height:500px;box-shadow: inset 1px -1px 1px #76c7c0, inset -1px 1px 1px#76c7c0;">
                <div class="row">
                  <div class="col-md-12" style="height:120px;box-shadow: inset 1px -1px 1px #76c7c0, inset -1px 1px 1px #76c7c0;">
                    <span class="label1" >按年份：</span>
                ...
                <div class="row">
                  <div class="col-md-12" style="height:380px; box-shadow: inset 1px -1px 1px #76c7c0, inset -1px 1px 1px #76c7c0;">
