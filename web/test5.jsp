...
<!--==============================content================================-->
<section id="content"><div class="ic">More Website Templates @ <a href="http://www.cssmoban.com/" >网页模板</a> - January 03, 2012!</div>
  <div class="main">
    ...
    <div class="container_12">
      <div class="wrapper">
        ...
        <article class="grid_3">
          ...
          <p class="prev-indent-bot3"><a class="link" target="_blank" href="http://www.cssmoban.com/">Free Html5 Templates</a></p>
          <p class="color-1 p0">Collect from cssmoban.com</p>
        </article>
      </div>
    </div>
  </div>
